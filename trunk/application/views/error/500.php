	...
	<div class="wrapper">
		...
		<div role="main" class="main">
			...
			<h1 class="h1"><?php echo $messages[mt_rand(0, 2)]; ?></h1>
                        <br><br><br>
			<h2 class="h2">Server Error <br><br>500 (Internal Server Error)</h2>
			...
			<br>
                        <div class="mean">
                            ...
                            <p>
                                Quelquechose s'est mal passé sur notre serveur lors de votre demande et nous en sommes désolés.
