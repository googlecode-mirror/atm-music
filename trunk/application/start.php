...
Autoloader::map(array(
	...
	'User_lif' => path('app').'models/user_lif.php',
	'Band' => path('app').'models/band.php',
	'Album' => path('app').'models/album.php',
	'Song' => path('app').'models/song.php',
	'Kind' => path('app').'models/kind.php',
	'SongAlbum' => path('app').'models/songAlbum.php',
	'SongKind' => path('app').'models/songKind.php',
));
